    ...
    <DefaultLayout>
      ...
      <Container sm css={{ minHeight: '70vh' }}>
        <Grid.Container alignItems="center">
          ...
          <Grid css={{ ml: '$4' }}>
            <Text h3>Itizawa</Text>
          </Grid>
          <Grid css={{ display: 'flex', gap: '$8', ml: 'auto' }}>
            ...
            <Link href="https://twitter.com/itizawa_pen" target="__blank">
              <Text color="white" css={{ cursor: 'pointer' }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
            ...
            <Link href="https://www.webev.cloud/ja" target="__blank">
